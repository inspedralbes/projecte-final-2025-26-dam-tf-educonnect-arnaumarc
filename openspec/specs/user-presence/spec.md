## Purpose
Gestionar y difundir el estado de disponibilidad y conexión de los usuarios en tiempo real para mejorar la interacción y evitar intentos de comunicación fallidos.
