...
El sistema SHALL reducir los márgenes internos (padding) del contenedor principal de Meet en pantallas móviles para maximizar el uso del espacio.

#### Scenario: Viewing Meet on mobile
- **WHEN** el ancho de pantalla es inferior a 640px
