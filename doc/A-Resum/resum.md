...
- Logos de les tecnologies utilitzades: 
    ...
    - **Integració**: Discord Bot (discord.js), WebRTC (Meet).
    - **Seguretat/Desplegament**: Fail2Ban, Caddy, Docker.

## Ús visual de l’app (captures)
- (TODO afegir 4–8 captures amb breu peu de foto)
