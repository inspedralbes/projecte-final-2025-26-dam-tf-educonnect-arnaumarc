...
| :--- | :--- | :--- | :--- |
| T1.1 | **Xat de l'Alumnat** | Sala comuna per a resolució de dubtes en temps real. | Marc Cara Montes |
| T1.2 | **Sistema Notificacions** | Servidor d'alertes automàtiques per a esdeveniments clau. | Marc Cara Montes |
| T1.3 | **Arquitectura Calendari** | Disseny visual del calendari d'exàmens i classes. | Arnau Perera Ganuza |
| T1.4 | **Calendari Setmanal** | Implementació de la vista d'agenda per a la gestió diària. | Arnau Perera Ganuza |
| T1.5 | **Sync d'Horaris** | Sincronització automàtica d'assignatures i hores de classe. | Arnau Perera Ganuza |
...
| ID | Tasca | Descripció Detallada | Responsable |
| :--- | :--- | :--- | :--- |
| T2.1 | **Xat Privat Prof-Alumne** | Canal segur i directe per a tutories personals. | Marc Cara Montes |
| T2.2 | **Alertes Professorat** | Notificacions instantànies al docent per missatges pendents. | Marc Cara Montes |
| T2.3 | **Bot de Notificacions** | Creació d'un agent automàtic per a avisos del sistema (EduBot). | Marc Cara Montes |
| T2.4 | **Notificacions d'Aula** | Interfície d'avisos segmentats per cada assignatura. | Arnau Perera Ganuza |
...
| ID | Tasca | Descripció Detallada | Responsable |
| :--- | :--- | :--- | :--- |
| T3.1 | **Gestor de Recursos** | Sistema de pujada de teoria, enllaços (URLs) i multimèdia. | Marc Cara Montes |
| T3.2 | **Horaris Dinàmics** | Eina de modificació d'horaris en temps real amb validació de col·lisions. | Marc Cara Montes |
| T3.3 | **Unificació de Dades** | Centralització de professors (MongoDB IDs) i neteja d'entorn. | Marc Cara Montes |
...
| ID | Tasca | Descripció Detallada | Responsable |
| :--- | :--- | :--- | :--- |
| T4.1 | **Perfil d'Usuari** | Gestió d'avatars i dades personals (nom, correu, rol). | Arnau Perera Ganuza |
| T4.2 | **Mòdul de Meet** | Integració de videollamades directes des de la plataforma. | Marc Cara Montes |
| T4.3 | **Directori d'Usuaris** | Llistat organitzat i visual de tota la comunitat acadèmica. | Marc Cara Montes |
...
| ID | Tasca | Descripció Detallada | Responsable |
| :--- | :--- | :--- | :--- |
| T5.1 | **Fase de Testing Alpha** | Proves de càrrega i funcionalitat interna de l'equip. | Marc Cara Montes |
| T5.2 | **QA Visual i UI/UX** | Poliment de la interfície i correcció de bugs de navegació. | Arnau Perera Ganuza |
| T5.3 | **Robust Notifications** | Redisseny del sistema de notificacions per evitar pèrdues de dades. | Marc Cara Montes |
| T5.4 | **Single Classroom Policy** | Implementació de la política d'aula única per coherència dades. | Marc Cara Montes |
...
r a la presentació del projecte.*
