                    ...
                    <div className="space-y-6">
                        ...
                        <div className="space-y-3">
                            {completed.map(({ student, submission }) => (
                                <div key={student._id} className="p-4 bg-white dark:bg-zinc-800/60 rounded-2xl border border-gray-100 dark:border-zinc-800 shadow-sm">
                                    ...
                                    <div className="bg-gray-50 dark:bg-zinc-900 p-3 rounded-xl border border-gray-100 dark:border-zinc-800">
